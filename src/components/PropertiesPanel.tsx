...
export const PropertiesPanel: React.FC = () => {
  ...
  return (
    <>
      {/* Mobile Backdrop when slide-up panel is open */}
      {isMobilePanelOpen && (
        <div
      ...
      <aside
        className={`
          bg-[#0c0d10] border-[#1f2128] flex flex-col select-none shrink-0 overflow-hidden transition-all duration-200
          ${/* Desktop styles */ ''}
          md:flex md:w-80 md:h-full md:border-l md:border-t-0 md:relative md:z-20 md:order-2
          ${/* Mobile Drawer styles */ ''}
          ${
            isMobilePanelOpen
              ? 'fixed inset-x-0 bottom-14 max-h-[65vh] z-40 border-t shadow-2xl flex md:h-full md:max-h-none md:inset-auto'
              : 'hidden md:flex'
          }
        `}
      >
        {/* Mobile Header Bar */}
        <div className="flex md:hidden items-center justify-between px-4 py-2.5 bg-[#141519] border-b border-[#23252b]">
          <span className="text-xs font-bold font-syne text-zinc-200 uppercase tracking-wider">
            Edit Options & Settings
          </span>
          <button
            onClick={() => setIsMobilePanelOpen(false)}
            className="p-1 text-zinc-400 hover:text-white min-w-[32px] min-h-[32px] flex items-center justify-center"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="flex items-center border-b border-[#1f2128] bg-[#090a0c] p-1 gap-1">
          <button
            ...
            className={`flex-1 min-h-[40px] md:min-h-[32px] py-1.5 text-xs font-bold font-syne rounded-none flex items-center justify-center space-x-1.5 transition ${
              activeTab === 'tools'
          ...
          <button
            ...
            className={`min-h-[40px] md:min-h-[32px] py-1.5 px-2.5 text-xs font-bold rounded-none flex items-center justify-center space-x-1 transition relative ${
              activeTab === 'layers'
                ? 'bg-white text-zinc-950 shadow-sm'
                : 'text-zinc-400 hover:text-zinc-200 hover:bg-[#18191e]'
            }`}
          ...
          <button
            ...
            className={`min-h-[40px] md:min-h-[32px] py-1.5 px-2.5 text-xs font-bold rounded-none flex items-center justify-center space-x-1 transition ${
              activeTab === 'adjust'
                ? 'bg-white text-zinc-950 shadow-sm'
                : 'text-zinc-400 hover:text-zinc-200 hover:bg-[#18191e]'
            }`}
